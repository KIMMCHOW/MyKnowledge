...
> [!definition] 定义
> Rho-f（$\rho_f$）或 Phi（$\Phi$）衡量期权理论价值对外国利率变化的局部敏感度；在带连续股息率的股票模型中，同类变量可写作股息率 $q$。
...
若股票模型把连续股息率 $q$ 作为持有收益输入，则相应敏感度为

$$
\Phi_q=\frac{\partial V}{\partial q}.
$$

两者都作用于持有标的相对于持有现金的成本收益关系，但 $r_f$ 与 $q$ 不是在所有产品中都可直接互换。
