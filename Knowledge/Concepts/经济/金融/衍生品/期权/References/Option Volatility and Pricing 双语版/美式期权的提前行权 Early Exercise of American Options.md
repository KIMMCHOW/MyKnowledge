---
title: 第16章 美式期权的提前行权 / Early Exercise of American Options
tags:
  - 期权
  - 双语阅读
section: 第16章
...
# 第16章 美式期权的提前行权 / Early Exercise of American Options
...
<!-- chapter-nav:start -->
> [!tip] 章节导航（章首）
> [[期权套利 Option Arbitrage|← 上一章]] · [[Option Volatility and Pricing 导航|全书导航]] · [[使用期权进行对冲 Hedging with Options|下一章 →]]
<!-- chapter-nav:end -->
