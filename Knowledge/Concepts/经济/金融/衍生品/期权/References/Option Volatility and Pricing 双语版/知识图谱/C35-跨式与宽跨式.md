...
# C35 跨式与宽跨式 / Straddles and Strangles
...
- **多头通常形成正凸性 →** [[C27-Gamma|C27 Gamma]]：多头跨式和宽跨式受益于大幅运动。
- **多头通常形成正波动率暴露 →** [[C29-Vega|C29 Vega]]：隐波上升通常提高多头结构价值。
- **多头通常承担时间衰减 →** [[C28-Theta|C28 Theta]]：若运动不足，权利金随时间损耗。
- **汇总成风险画像 →** [[C32-组合Greeks与头寸分析|C32 组合Greeks与头寸分析]]：波动率策略不能只用名称判断风险。
