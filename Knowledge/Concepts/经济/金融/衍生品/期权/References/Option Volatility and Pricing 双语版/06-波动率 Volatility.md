...
tags:
  ...
  - 双语阅读
section: 第6章
translation_status: 人工复核中；时间尺度换算与高风险机翻已校正
created: 2026-08-03
---
...
> [!warning] 翻译状态
> 本章以机器初译为底稿，正在逐段人工复核。波动率的时间尺度换算、关键数值与高风险金融术语已经校正；其余中文仍会继续修订。英文原文、数字、公式和图表保留用于核对。
...
<!-- chapter-nav:start -->
> [!tip] 章节导航（章首）
> [[05-理论定价模型 Theoretical Pricing Models|← 上一章]] · [[90-阅读导航|全书导航]] · [[07-风险度量（一） Risk Measurement I|下一章 →]]
<!-- chapter-nav:end -->
