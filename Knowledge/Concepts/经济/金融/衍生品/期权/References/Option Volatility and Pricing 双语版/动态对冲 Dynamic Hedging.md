...
<!-- chapter-nav:start -->
> [!tip] 章节导航（章首）
> [[风险度量（一） Risk Measurement I|← 上一章]] · [[阅读导航|全书导航]] · [[风险度量（二） Risk Measurement II|下一章 →]]
<!-- chapter-nav:end -->
...
显然，我们的第一步将是购买6 月到期、行权价为 100 的看涨期权，因为它的价格被低估了0.89。我们现在可以离开头寸并在到期时回来收款吗？在我们之前对理论定价模型的讨论中，我们指出，购买或出售理论上定价错误的期权需要我们通过在标的合约中采取相反头寸来建立中性对冲。当正确操作时，对于标的合约价格的微小变化，期权头寸价值的增加或减少将恰好抵消标的合约中对立头寸价值的减少或增加。对于标的合约的方向性变动，这种对冲是无偏或中性的。
...
为了建立适当的无风险对冲，我们需要确定6月100看涨期权的Delta。使用我们的理论定价模型，我们发现该期权的Delta为50。每买入一张看涨期权，我们就必须卖出0.50个（即半个）标的合约。由于通常无法买卖非整数单位的标的合约，因此假设我们买入100张6月到期、行权价为100的看涨期权，并卖出50个标的合约。[^ovp08-1] 我们现在持有以下Delta中性头寸：

<!-- source:block 5ae4c5ec270f988d -->

> [!note] 译者注：碎股交易
> 若标的是股票，且券商支持碎股交易，则可以按非整数股数进行对冲。不过，本例需要卖出标的，是否支持碎股卖出或卖空仍以券商规则为准。
...
根据前面的讨论，散户和专业交易员可能会以某种不同的方式进行期权交易，即使他们都理解并使用理论定价模型产生的价值。专业交易员，特别是如果他是交易所会员，交易成本相对较低。由于与对冲的预期理论利润相比，调整的成本很少，因此他倾向于频繁进行调整。相比之下，建立相同对冲的散户将不太愿意调整或调整频率较低，因为任何调整都会降低头寸的盈利能力。了解概率定律的散户会意识到自己的头寸与专业交易者的头寸具有相同的有利赔率，但他也应该意识到自己的头寸对短期好运气和坏运气的影响更加敏感。尽管零售客户偶尔会经历比专业交易员更大的损失，但他偶尔也会经历更大的利润。从长远来看，平均而言，两者最终应该会获得大致相同的利润。[^ovp08-4]
