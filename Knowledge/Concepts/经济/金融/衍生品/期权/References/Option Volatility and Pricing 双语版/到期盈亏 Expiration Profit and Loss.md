---
title: 第4章 到期盈亏 / Expiration Profit and Loss
tags:
  - 期权
  - 双语阅读
section: 第4章
...
# 第4章 到期盈亏 / Expiration Profit and Loss
...
<!-- chapter-nav:start -->
> [!tip] 章节导航（章首）
> [[合约规格与期权术语 Contract Specifications and Option Terminology|← 上一章]] · [[Option Volatility and Pricing 导航|全书导航]] · [[理论定价模型 Theoretical Pricing Models|下一章 →]]
<!-- chapter-nav:end -->
