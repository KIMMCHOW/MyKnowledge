---
title: 第10章 价差策略导论 / Introduction to Spreading
tags:
  - 期权
  - 双语阅读
section: 第10章
...
# 第10章 价差策略导论 / Introduction to Spreading
...
<!-- chapter-nav:start -->
> [!tip] 章节导航（章首）
> [[风险度量（二） Risk Measurement II|← 上一章]] · [[Option Volatility and Pricing 导航|全书导航]] · [[波动率价差策略 Volatility Spreads|下一章 →]]
<!-- chapter-nav:end -->
