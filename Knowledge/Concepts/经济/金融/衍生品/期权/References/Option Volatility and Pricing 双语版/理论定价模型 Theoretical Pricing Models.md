---
title: 第5章 理论定价模型 / Theoretical Pricing Models
tags:
  - 期权
  - 双语阅读
section: 第5章
...
# 第5章 理论定价模型 / Theoretical Pricing Models
...
<!-- chapter-nav:start -->
> [!tip] 章节导航（章首）
> [[到期盈亏 Expiration Profit and Loss|← 上一章]] · [[Option Volatility and Pricing 导航|全书导航]] · [[波动率 Volatility|下一章 →]]
<!-- chapter-nav:end -->
