...
- **汇总为组合暴露 →** [[C32-组合Greeks与头寸分析|C32 组合Greeks与头寸分析]]：各腿 Rho 形成利率风险。

### 受上游约束

- [[C22-Black-Scholes模型|C22 Black-Scholes模型]] **—导出局部敏感度→ 本概念**：模型衡量利率输入变化的局部影响。
- [[C08-利率与融资成本|C08 利率与融资成本]] **—变化时经由Rho传导→ 本概念**：利率变化影响贴现和远期。
