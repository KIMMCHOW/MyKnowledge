...
- **汇总为百分比杠杆 →** [[组合Greeks与头寸分析|C32 组合Greeks与头寸分析]]：Lambda 为组合提供资本敏感的方向暴露视角。
- **约束资本与头寸规模 →** [[策略选择与调整|C41 策略选择与调整]]：高弹性头寸需与最大损失、保证金和可退出性一起决定规模。

### 受上游约束

- [[Delta（Natenberg）|C26 Delta]] **—与价格共同定义→ 本概念**：Lambda 将绝对 Delta 转为百分比弹性。
