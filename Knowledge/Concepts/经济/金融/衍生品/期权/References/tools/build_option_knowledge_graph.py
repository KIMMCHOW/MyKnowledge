...
CHAPTERS = {
    1: ("金融合约 Financial Contracts", "金融合约"),
    2: ("远期定价 Forward Pricing", "远期定价"),
    3: ("合约规格与期权术语 Contract Specifications and Option Terminology", "合约规格与期权术语"),
    4: ("到期盈亏 Expiration Profit and Loss", "到期盈亏"),
    5: ("理论定价模型 Theoretical Pricing Models", "理论定价模型"),
    6: ("波动率 Volatility", "波动率"),
    7: ("风险度量（一） Risk Measurement I", "风险度量（一）"),
    8: ("动态对冲 Dynamic Hedging", "动态对冲"),
    9: ("风险度量（二） Risk Measurement II", "风险度量（二）"),
    10: ("价差策略导论 Introduction to Spreading", "价差策略导论"),
    11: ("波动率价差策略 Volatility Spreads", "波动率价差策略"),
    12: ("牛市与熊市价差 Bull and Bear Spreads", "牛市与熊市价差"),
    13: ("风险考量 Risk Considerations", "风险考量"),
    14: ("合成头寸 Synthetics", "合成头寸"),
    15: ("期权套利 Option Arbitrage", "期权套利"),
    16: ("美式期权的提前行权 Early Exercise of American Options", "美式期权的提前行权"),
    17: ("使用期权进行对冲 Hedging with Options", "使用期权进行对冲"),
    18: ("Black–Scholes 模型 The Black-Scholes Model", "Black–Scholes 模型"),
    19: ("二叉树期权定价 Binomial Option Pricing", "二叉树期权定价"),
    20: ("再论波动率 Volatility Revisited", "再论波动率"),
    21: ("头寸分析 Position Analysis", "头寸分析"),
    22: ("股票指数期货与期权 Stock Index Futures and Options", "股票指数期货与期权"),
    23: ("模型与现实世界 Models and the Real World", "模型与现实世界"),
    24: ("波动率偏斜 Volatility Skews", "波动率偏斜"),
    25: ("波动率合约 Volatility Contracts", "波动率合约"),
}
